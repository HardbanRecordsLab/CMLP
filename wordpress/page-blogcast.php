        ...
        <aside class="sidebar-panel" id="blogcastSidebar">
            ...
            <div class="widget newsletter-widget">
                <div class="newsletter-content">
                    ...
                    <form action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="POST" id="hrl-newsletter">
                        ...
                        <div class="checkbox-group">
                            <input type="checkbox" id="zgoda" name="subscriber_consent" value="1" required>
                            <label for="zgoda"><?php esc_html_e( 'Akceptuję politykę prywatności i wyrażam zgodę na przesyłanie analiz oraz raportów branżowych.', 'hrl-theme' ); ?></label>
                        </div>
            ...
            <div class="widget">
                ...
                <p style="font-size:0.8rem;color:var(--text-secondary);">
                    ...
                    $parent_cats_count = count( get_categories( array( 'parent' => 0, 'hide_empty' => false ) ) ) - 1; // minus uncategorized
                    printf(
                        /* translators: 1: total category count, 2: published post count, 3: primary pillar count */
