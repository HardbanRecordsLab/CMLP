...
<div class="legal-content">
    ...
    <h2><?php esc_html_e( '4. Licencje i prawa autorskie', 'hrl-theme' ); ?></h2>
    ...
    <h2><?php esc_html_e( '7. Reklamacje', 'hrl-theme' ); ?></h2>
    <p><?php esc_html_e( 'Reklamacje można składać drogą elektroniczną na adres contact@hardbanrecordslab.online. Rozpatrujemy je w terminie 14 dni roboczych.', 'hrl-theme' ); ?></p>
