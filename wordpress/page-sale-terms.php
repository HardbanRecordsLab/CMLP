...
<div class="legal-content">
    ...
    <p><?php esc_html_e( 'Sprzedawca: HardbanRecords Lab. Klient: podmiot gospodarczy (B2B) nabywający licencję na muzykę komercyjną. Licencja: dokument uprawniający do publicznego odtwarzania muzyki w oznaczonym lokalu z wyłączeniem opłat OZZ.', 'hrl-theme' ); ?></p>

    <h2><?php esc_html_e( '2. Ceny i płatności', 'hrl-theme' ); ?></h2>
    <p><?php esc_html_e( 'Ceny podane są w PLN i zawierają VAT. Pakiety: Basic (99 zł/mies.), Standard (199 zł/mies.), Premium (299 zł/mies.), Enterprise (499 zł/mies.). Płatności realizowane przez Stripe. Faktura wystawiana automatycznie po zaksięgowaniu płatności.', 'hrl-theme' ); ?></p>
