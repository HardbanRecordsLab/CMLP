      ...
      <div className="w-full max-w-md bg-slate-900 text-slate-300 rounded-xl shadow-2xl border border-slate-800 overflow-hidden flex flex-col">
        <div className="flex items-center justify-between p-4 border-b border-slate-800 bg-slate-950">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-semibold text-white">Upload New Track</h2>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="col-span-2">
                <label className="block text-[10px] uppercase tracking-widest text-slate-500 mb-1">Audio File (MP3, WAV, FLAC)</label>
              ...
              <div className="col-span-2">
                <label className="block text-[10px] uppercase tracking-widest text-slate-500 mb-1">Track Title (Optional, parsed from file)</label>
              ...
              <div className="col-span-2">
                <label className="block text-[10px] uppercase tracking-widest text-slate-500 mb-1">Artist (Optional, parsed from file)</label>
              ...
              <div>
                <label className="block text-[10px] uppercase tracking-widest text-slate-500 mb-1">ISRC Code</label>
                <input value={isrc} onChange={e => setIsrc(e.target.value)} placeholder="PLHRL26..." className="w-full bg-slate-950 border border-slate-800 rounded px-3 py-2 text-sm font-mono text-white focus:outline-none focus:border-blue-500" />
              </div>
              <div>
                <label className="block text-[10px] uppercase tracking-widest text-slate-500 mb-1">BPM (Optional)</label>
              ...
              <div>
                <label className="block text-[10px] uppercase tracking-widest text-slate-500 mb-1">Genre</label>
              ...
              <div>
                <label className="block text-[10px] uppercase tracking-widest text-slate-500 mb-1">Mood (Comma sep)</label>
