...
// peaks and no extra dependency. Same component/behavior as HRL Sync Hub's
// WaveformSeekbar (AudioPlayerBar) — each app keeps its own copy per the
...
// mounts (track re-selected) instead of re-fetching and re-decoding the whole
// file every time.
